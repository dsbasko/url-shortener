...
//go:generate ../../../bin/mockgen -destination=./mocks/mutator.go -package=mock_urls github.com/dsbasko/url-shortener/internal/service/urls Mutator
//go:generate ../../../bin/mockgen -destination=./mocks/provider.go -package=mock_urls github.com/dsbasko/url-shortener/internal/service/urls Provider
//go:generate ../../../bin/mockgen -destination=./mocks/analyzer.go -package=mock_urls github.com/dsbasko/url-shortener/internal/service/urls Analyzer
